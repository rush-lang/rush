...
namespace rush {
   ...
   namespace tokens {
      ...
      lexical_token make_comment_token(std::string, location const& = location::undefined, rush::source const& = rush::source::none);
   ...
   class lexical_token final {
      ...
      struct comment_t {
         std::string comm;
         friend bool operator == (comment_t const& lhs, comment_t const& rhs) {
      ...
      friend lexical_token tokens::make_comment_token(std::string, location const&, rush::source const&);
   ...
   public:
      ...
      lexical_token_type type() const noexcept {
         return std::visit(overloaded {
            ...
            [](comment_t) { return lexical_token_type::comment; },
      ...
      bool is_comment() const noexcept {
         return std::holds_alternative<comment_t>(_val);
      }
